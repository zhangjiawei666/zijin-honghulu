...
interface ChatPageProps {
  ...
  /** 新对话默认智能体（由新建对话弹窗传入） */
  initialNewChatAgentId?: string;
  /** 新对话默认工作目录（由新建对话弹窗传入） */
  initialNewChatCwd?: string;
}
...
export function ChatPage({
  ...
  // 新对话页面状态
  const [newChatAgentId, setNewChatAgentId] = useState(initialNewChatAgentId || 'default');
  const [newChatCwd, setNewChatCwd] = useState(initialNewChatCwd || '');
